...
[![License](https://img.shields.io/badge/License-ACM-blue.svg)](https://www.acm.org/)
[![Conference](https://img.shields.io/badge/Conference-FDG%202026-green.svg)](https://fdg2026.org/)
...
- **Bryan Berry** - California State University, Monterey Bay
  Email: bberry@csumb.edu
...
```bibtex
@inproceedings{clinkenbeard2026bridging,
  author = {Clinkenbeard, Drew A. and Berry, Bryan},
  title = {Bridging the Gap: Extended Game Development Projects for Student Employability and Experiential Learning},
  booktitle = {Foundations of Digital Games 2026},
  series = {FDG '26},
  year = {2026},
  month = {May},
  publisher = {ACM},
...
*Note: DOI will be updated upon publication.*
...
- CSUMB Computer Science Department: [https://csumb.edu/scd/](https://csumb.edu/scd/)
- FDG Conference: [https://fdg.org/](https://fdg.org/)
...
**Submitted to:** Foundations of Digital Games 2026
